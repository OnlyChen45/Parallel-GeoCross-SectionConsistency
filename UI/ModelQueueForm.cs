...
{
    public partial class ModelQueueForm : Form
    {
        public string[] pathlist;
        public ModelQueueForm()
        {
            InitializeComponent();
        }

        private void ModelQueueForm_Load(object sender, EventArgs e)
        {
            FrmMain frm = (FrmMain)this.Owner;
            foreach (var vk in frm.modellist) {//加载建模队列
                int p = vk.Key;
                string[] st = vk.Value;
